...
const translations = {
    en: {
        ...
        paymentDesc1: "Paid when your friend passes the AI Interview assessment",
        paymentDesc2: "Paid after 90 days of successful employment",
        ...
        paymentTermsText3: "All payments are subject to verification and may take up to 30 days after each milestone.",
        closeBtn: "Close",
        ...
        howItWorksTitle: "How xRAF Works",
        totalEarning: "Total Earning: RM800 per successful referral",
        step1: "Refer a Friend",
        step2: "Pass Assessment",
        step3: "Get Hired",
        step4: "90 Days"
    },
    ja: {
        ...
        paymentDesc1: "候補者がAI面接評価に合格した時に支払われます",
        paymentDesc2: "90日間の雇用成功後に支払われます",
        ...
        paymentTermsText3: "すべての支払いは確認が必要であり、各マイルストーン後最大30日かかる場合があります。",
        closeBtn: "閉じる",
        ...
        howItWorksTitle: "xRAFの仕組み",
        totalEarning: "合計収益: 成功した紹介1件につきRM800",
        step1: "友達を紹介",
        step2: "審査合格",
        step3: "採用される",
        step4: "90日間"
    ...
    ko: {
        ...
        paymentDesc1: "친구가 AI 면접 평가에 합격할 때 지급됩니다",
        paymentDesc2: "90일간 성공적인 고용 후 지급됩니다",
        ...
        paymentTermsText3: "모든 결제는 확인이 필요하며 각 마일스톤 후 최대 30일이 소요될 수 있습니다.",
        closeBtn: "닫기",
        ...
        howItWorksTitle: "xRAF 작동 방식",
        totalEarning: "총 수익: 성공한 추천 1건당 RM800",
        step1: "친구 추천",
        step2: "평가 통과",
        step3: "채용",
        step4: "90일"
    ...
    "zh-CN": {
        ...
        howItWorksTitle: "xRAF工作原理",
        totalEarning: "总收益：每个成功推荐RM800",
        step1: "推荐朋友",
        step2: "通过评估",
        step3: "被雇用",
        step4: "90天"
